    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5 space-y-4">
          <div>
            <h4 className="text-sm font-semibold text-gray-900 mb-1">SM-DP+ (Subscription Manager – Data Preparation+)</h4>
          ...
          <div>
            <h4 className="text-sm font-semibold text-gray-900 mb-1">LPA (Local Profile Assistant)</h4>
            <p className="text-sm text-gray-600">
          ...
          <div>
            <h4 className="text-sm font-semibold text-gray-900 mb-1">EID (eUICC Identifier)</h4>
            <p className="text-sm text-gray-600">
          ...
          <div>
            <h4 className="text-sm font-semibold text-gray-900 mb-1">SM-DS (Subscription Manager – Discovery Server)</h4>
            <p className="text-sm text-gray-600">
      ...
      <div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 divide-y divide-gray-100">
          <div className="p-5">
            <h4 className="text-sm font-semibold text-gray-900 mb-1">1. QR code (most common)</h4>
            <p className="text-sm text-gray-600">
          ...
          <div className="p-5">
            <h4 className="text-sm font-semibold text-gray-900 mb-1">2. Manual entry</h4>
            <p className="text-sm text-gray-600">
          ...
          <div className="p-5">
            <h4 className="text-sm font-semibold text-gray-900 mb-1">3. Carrier / provider app</h4>
            <p className="text-sm text-gray-600">
          ...
          <div className="p-5">
            <h4 className="text-sm font-semibold text-gray-900 mb-1">4. Operator-initiated (push in the strict sense)</h4>
            <p className="text-sm text-gray-600">
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-xl p-5">
        <h3 className="text-sm font-semibold text-gray-900 mb-2">Quick reference</h3>
